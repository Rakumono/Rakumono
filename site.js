...
(function($){
	...
	var that = {
		...
		var handler = {
			...
			}else if ($.inArray(nearest.node.name, menu) >=0 ){
	...
	var theUI = {
	    nodes:{SUIEI:{color:"red", shape:"dot", alpha:1}, 
		   
		   boushi:{color:CLR.branch, shape:"dot", alpha:1}, 
		   halfviz:{color:CLR.demo, alpha:0, link:'/halfviz', src:"image/2.jpg", caption:"This is my test node, what if the caption is very looooooooooooooooooooooooooooooooooooooooooooong"},
		   ...
		   shuiyong:{color:CLR.code, alpha:0, link:'https://github.com/samizdatco/arbor'},
